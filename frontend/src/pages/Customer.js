...
const Customer = () => {
  ...
  piechart_data.push({name:"remaining",value:total_budget - Food - Health - Shopping})
    ...
    <div className="home-customer">
      <div className="home-customer-top-boxes">
          ...
          <div className="home-customer-top-box ">
           ...
           <span><FastfoodIcon sx={{color:lightGreen}} /></span>
            </div>
          <div className="home-customer-top-box ">
            <span>&#8377; {Shopping}</span>
           <span>Shopping Expenses:</span> 
           <span><ShoppingCartIcon color="primary" /></span>
            </div>
          <div className="home-customer-top-box ">
            <span>&#8377; {Health}</span>
           <span>Health Expenses:</span>   
           <span><HealthAndSafetyIcon sx={{ color: pink[500] }} /></span>  
            </div>
        ...
        <div className="home-customer-mid-expense">
          ...
          <PieChart width={240} height={350} style={{position:"absolute",left:"10px",top:"10px"}} >
        <Pie
          data={piechart_data}
          cx={120}
          cy={200}
        ...
        >
          ...
          <div className="expense-history">
            <div className="expense-details-heading"><span>Item</span><span>Amount</span><span>Category</span> </div>
          {expense &&
